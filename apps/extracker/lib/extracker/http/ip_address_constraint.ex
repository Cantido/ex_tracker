defmodule Extracker.HTTP.IPAddressConstraint do
  ...
  ## Examples
      ...
      iex> Extracker.HTTP.IPAddressConstraint.ip_address(:forward, "127.0.0.1")
      {:ok, {127, 0, 0, 1}}

      iex> Extracker.HTTP.IPAddressConstraint.ip_address(:forward, "fe80::490a:b2ca:6978:75dc")
      {:ok, {65152, 0, 0, 0, 18698, 45770, 27000, 30172}}

      iex> Extracker.HTTP.IPAddressConstraint.ip_address(:reverse, {127, 0, 0, 1})
      {:ok, "127.0.0.1"}
  """
