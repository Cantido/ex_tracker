defmodule ExtrackerServer.Peer do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ExtrackerServer.Peer.new(<<0>>)
      %ExtrackerServer.Peer{ip: {0, 0, 0, 0}, last_announce: :never, peer_id: <<0>>, port: 0}

  """
  def new(peer_id) when is_binary(peer_id) do
    %ExtrackerServer.Peer{peer_id: peer_id}
  end
  ...
  ## Examples
      ...
      iex> ExtrackerServer.Peer.new(<<0>>, -576460725)
      %ExtrackerServer.Peer{ip: {0, 0, 0, 0}, last_announce: -576460725, peer_id: <<0>>, port: 0}

  """
  def new(peer_id, last_announce) when is_binary(peer_id) do
    %ExtrackerServer.Peer{peer_id: peer_id, last_announce: last_announce}
  end
  ...
  ## Examples
      ...
      iex> peer = ExtrackerServer.Peer.new(<<0>>, 0)
      iex> ExtrackerServer.Peer.too_old?(peer, 5, 10)
      true

      iex> peer = ExtrackerServer.Peer.new(<<0>>, 0)
      iex> ExtrackerServer.Peer.too_old?(peer, 10, 7)
      false
  """
  ...
  ## Examples
      ...
      iex> peer = ExtrackerServer.Peer.new(<<0>>, 0)
      iex> ExtrackerServer.Peer.age(peer, 10)
      10
  """
