alias ExtrackerServer.Torrent

defmodule ExtrackerServer.TorrentRegistry do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ExtrackerServer.TorrentRegistry.new()
      %ExtrackerServer.TorrentRegistry{}
  """
  def new do
    %ExtrackerServer.TorrentRegistry{}
  end
  ...
  ## Examples
      ...
      iex> registry = ExtrackerServer.TorrentRegistry.new()
      iex> peer = ExtrackerServer.Peer.new(<<0>>)
      iex> info_hash = <<20>>
      iex> size(registry.torrents)
      0
      iex> registry1 = ExtrackerServer.TorrentRegistry.add_peer_to_torrent(registry, info_hash, peer)
      iex> size(registry1.torrents)
      1
      iex> another_peer = ExtrackerServer.Peer.new(<<1>>)
      iex> registry2 = ExtrackerServer.TorrentRegistry.add_peer_to_torrent(registry, info_hash, another_peer)
  ...
  def clean_torrents(registry, max_age, current_time) when max_age >= 0 do
    clean_fun = &ExtrackerServer.Torrent.drop_old_peers(&1, max_age, current_time)
